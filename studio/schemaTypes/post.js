...
export default defineType({
  ...
  fields: [
    ...
    defineField({ name: 'title_zh', title: 'Title (ZH)', type: 'string', readOnly: true,
      description: '英文原文时自动翻译为中文' }),
    ...
    defineField({ name: 'summary_zh', title: 'Summary (ZH)', type: 'text', rows: 3, readOnly: true }),
    defineField({ name: 'category_en', title: 'Category (EN)', type: 'string', readOnly: true }),
    defineField({ name: 'category_es', title: 'Category (ES)', type: 'string', readOnly: true }),
    defineField({ name: 'category_zh', title: 'Category (ZH)', type: 'string', readOnly: true }),

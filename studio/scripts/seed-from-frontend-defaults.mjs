...
const { siteSettingsDoc, homePageDoc } = getSeedDocuments();
...
async function main() {
  ...
  console.log('[seed] 已写入（或覆盖）siteSettings、homePage 的已发布文档。');
  console.log('[seed] 含：页脚一句话/版权、导航、联系方式、首页 Hero 等。请在 Studio 中刷新页面查看；无需再点 Publish。');

/**
 * Vercel Serverless Function — 产品 / 分类 / 资讯 / FAQ 自动翻译（ZH → EN / ES / PT / AR / RU）
...
async function processPost(doc) {
  ...
  if (doc.translationSourceHash === currentHash && !hasMissingPostLocales()) {
